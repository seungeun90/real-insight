...
public class AptTradeController {
    ...
    @Operation(summary = "지역 내 아파트 매매 정보 조회", description = "지역 내 아파트 매매 정보를 반환한다.")
    @ApiResponse(responseCode = "200", description = "성공",
            content = @Content(array = @ArraySchema(schema = @Schema(implementation = AptTradeProfit.class))))
    ...
    public ResponseEntity<?> getAptTrade(@PathVariable("region") String regionCode,
        ...
        return ResponseData.success(aptTradeInfo);
    }
